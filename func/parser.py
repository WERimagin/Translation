...
def get_args():
    ...
    ##データのオプション
    parser.add_argument("--src_length", type=int, default="100", help="input train batch size")
    parser.add_argument("--tgt_length", type=int, default="100", help="input test batch size")
    ...
    parser.add_argument("--include_pad", type=bool, default=True, help="input epoch number")
